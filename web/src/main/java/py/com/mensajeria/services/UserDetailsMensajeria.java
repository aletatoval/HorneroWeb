...
public class UserDetailsMensajeria extends User {
    ...
    public UserDetailsMensajeria(String username, String password,
	...
	public static UserDetailsMensajeria getUsuarioAutenticado() {
        return ((UserDetailsMensajeria) SecurityContextHolder.getContext().getAuthentication().getPrincipal());
    }
