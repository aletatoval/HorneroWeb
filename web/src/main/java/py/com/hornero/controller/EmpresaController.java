...
public class EmpresaController extends BaseController {
	...
	public HashMap<String, Object> agregarEmpresa(@RequestBody Empresa nuevo,  HttpServletResponse response) {
		...
		logger.info("Inició correctamente el método agregar empresas por el funcionario "
		...
		try {
			...
			empresaManager.crear(nuevo, userDetails.getIdFuncionario());
...
//			empresa.setIdUsuarioCreacion(anterior.getIdFuncionarioCreacion());
			empresa.setId(id);
			...
			empresaManager.actualizar(empresa, userDetails.getIdFuncionario());
	...
	HashMap<String, Object> desactivar(@PathVariable("id") Long id) {
		...
		try {
			...
			empresaManager.desactivar(id, userDetails.getIdFuncionario());
	...
	HashMap<String, Object> activar(@PathVariable("id") Long id) {
		...
		try {
			...
			empresaManager.activar(id, userDetails.getIdFuncionario());
	...
	public HashMap<String, Object> agregarRol(@PathVariable("id") Long idEmpresa,
		...
		logger.info("Inició correctamente el método agregar rol por el funcionario "
				+ userDetails.getNombreCompleto());
		...
		try {
			...
			rol = rolManager.crear(nuevo, userDetails.getIdFuncionario());
